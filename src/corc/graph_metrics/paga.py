...
class PAGA(Graph):
    def __init__(self, latent_dim, data=None, labels=None, path=None, resolution=0.1, clustering_method='leiden', seed=42):
        """
    ...
    def create_graph(self, save=True):
        ...
        self.graph_data = {'nodes':cluster_means, 'edges':edges, 'nodes_org_space':nodes_org_space}
